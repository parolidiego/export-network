...
whether the observed clustering coefficient is significantly greater
than what would be expected under a random graph with the same degree
distribution.
...
**0.034**. The result of the t-test showed that the observed value is
significantly higher than the expected values under the null model
